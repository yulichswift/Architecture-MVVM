...
import com.jeff.architecture_mvvm.view.github.GitUserViewHolder

class GitUserAdapter2 : PagingDataAdapter<UserItem, RecyclerView.ViewHolder>(DiffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GitUserViewHolder {
        val view = inflateWithLayout(parent, R.layout.item_user_info2)
